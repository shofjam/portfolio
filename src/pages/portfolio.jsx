...
const Portfolio = () => {
  ...
  var data = [
    ...
    },
    {
      ...
      year: "2022-2023",
      description:
        "We manage the data sent from an Oracle application to a RabbitMQ pool. The data then generated and processed for reporting needs. There are 9 services in total, including data generation, data management, reporting, authentication, and files.",
      technicalStack:
        ".NET Core, ASP.NET Core MVC, jQuery, RabbitMQ, Dapper, Microsoft SQL Server, Microservices, GitLab",
      images: [
        {
    ...
    },
    {
      ...
      year: "2022",
      description:
        "This web application handles partnership registration for gas stations and LPG station dasboard for Pertamina.",
      technicalStack:
        ".NET Core, ASP.NET Core MVC, Highcharts, jQuery, RabbitMQ, Microsoft SQL Server, Stored Procedures, Microservices, GitLab",
      images: [
        {
    ...
    },
    {
      ...
      year: "2023",
      description:
        "This web application handles ships or vessels for delivering products owned by Pertamina.",
      technicalStack:
        ".NET Core, ASP.NET Core MVC, Highcharts, jQuery, RabbitMQ, Microsoft SQL Server, Stored Procedures, Microservices, GitLab",
      images: [
        {
    ...
    },
    {
      ...
      year: "2019",
      description:
        "A Platform to manage the system in transportation companies",
  ...
  var sampleCodes = [
    ...
    {
      platform: "ReactJS",
      images: ["img/portfolios/SampleCodes-ReactJS1.png"],
    },
    {
      platform: "CSS",
      images: ["img/portfolios/SampleCodes-CSS.png"],
    },
  ];
  ...
  return (
    <>
      ...
      <Typography variant="lead" className="my-1">
        These are the projects I have worked on. Some projects cannot be shown due to the permissions.
      </Typography>
            ...
            <Card className="mt-10 w-full">
              <CardBody>
                ...
                <Carousel
                  ...
                  className="rounded-xl h-95 cursor-pointer overflow-hidden transition-opacity hover:opacity-90"
                >
                  {project.images.map((projectImage, idx) => (
                    <React.Fragment key={"project-" + index + "-image-" + idx}>
                      <figure
                        className="relative h-full w-full"
                        onClick={() => handleOpenDialog(projectImage)}
                      >
                        <img
                ...
                <Typography className="mt-2">{project.description}</Typography>
                <Typography
                  variant="small"
                  color="gray"
      ...
      <Dialog size="xl" open={openDialog} handler={() => handleOpenDialog({})}>
        <DialogHeader className="justify-between">
          <div className="flex items-center gap-3">
            <Typography variant="lead">{dialogImage.description}</Typography>
          </div>
      ...
      <hr className="mt-10" />
      <Typography variant="h3" className="my-1 mt-5">
        Sample Codes
      </Typography>
      <div className="grid grid-cols-1 gap-4">
              ...
              <CardBody>
                ...
                >
                  {sampleCode.images.map((codeImage, idx) => (
                    <React.Fragment
                      key={"samplecode-" + index + "-image-" + idx}
                    >
